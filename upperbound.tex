...
%+
%\sqrt{\frac2{\pimin\gap^2n}\log(2d/\delta)}
\le
23 \sqrt{  \pi_i 
...
%   \geq
%   1 + \frac{1}{\gap} \log \frac1{|H_s|\sqrt{\pimin}\gap}
\end{equation}
\todoc{By using the geometric series bound,
we can derive that it is enough
if $a\ge 1 + \frac{1}{\gap} \log \frac1{|H_s|\sqrt{\pimin}\gap}$,
...
%\begin{equation}
%  \label{eq:block-length}
%  |F| \geq 1 + \frac{1}{\gap} \log \frac1{\pimin\gap}
%  .
%\end{equation}
%Then
%\[

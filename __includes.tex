...
\hypersetup{
    ...
    unicode=false,          % non-Latin characters in AcrobatÃÂ•s bookmarks
    pdftoolbar=true,        % show AcrobatÃÂ•s toolbar?
    pdfmenubar=true,        % show AcrobatÃÂ•s menu?
...
\fi
\usepackage[capitalize,poorman]{cleveref}

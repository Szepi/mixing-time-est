...
As it was noted in the introduction, the 
 \emph{mixing time} of the Markov chain $\tmix$ defined by~\eqref{eq:mixtimedef}
 can be trapped in the interval $[ \Parens{\frac1{\gap} - 1} \log2,\frac1{\gap} \log \frac4{\pimin}]$.
>>>>>>> Stashed changes

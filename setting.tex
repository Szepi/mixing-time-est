...
As we will see later, we will strongly exploit this later.  \todoc{Say more? Maybe not..}
...
$\gap$, as we will show in the proof of our first result.\todoc{I removed the citations (saving space), referring to the proof.}
